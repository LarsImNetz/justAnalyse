...
public class TestPredicate {
	 ...
	 * 
	 * Predicate<T> ist eine Funktion, die ein Objekt vom Typ T einem logischen Testkriterium unterzieht und damit ein Spezialfall von Function mit
	 * Rückgabeergebnis vom Typ boolean. Ein typisches Nutzungsszenario für Predicate<T>-Instanzen ist die Filterung von Collections. Ein solches Predicate
	 ...
	 * }
	 * Predicate kodiert also ein Testkriterium mit Rückgabewert als boolesches Testergebnis. Man kann Instanzen über booleschen Operatoren verknüpfen, um
	 * komplexere Testkriterien zu erhalten, etwa wie folgt:
	 */
	...
	public interface Predicate<T> {
		...
		default Predicate<T> negate() { return egal -> !test(egal); }
